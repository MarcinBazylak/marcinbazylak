...
<div class="projects">
   ...
   <div class="projects_description">
      <h3><?php echo $lng[19] ?></h3><?php echo $lng[20] ?>
      <br>
      <b><?php echo $lng[1] ?></b>
      <br>
      <?php echo $lng[2] ?>
...
<div class="projects">
   ...
   <div class="projects_description">
      <h3><a href="http://photolio.pl">photolio.pl</a></h3><?php echo $lng[26] ?>
      <br>
      <b><?php echo $lng[1] ?></b>
      <br>
      <?php echo $lng[2] ?>
...
<div class="projects">
   ...
   <div class="projects_description">
      <h3><a href="http://motolux.cba.pl" target="_blank">moto-lux</a></h3><?php echo $lng[31] ?>
      <br>
      <b><?php echo $lng[1] ?></b>
      <br>
      <?php echo $lng[2] ?>
